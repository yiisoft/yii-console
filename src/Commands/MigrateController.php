 ...
 *     'controllerMap' => [
 *         'migrate' => [
 *             '__class' => 'Yiisoft\Yii\Console\Controllers\MigrateController',
 *             'migrationNamespaces' => [
 *                 'app\migrations',
...
class MigrateController extends BaseMigrateController
{
     ...
     * {@inheritdoc}
     */
    public $templateFile = '@Yiisoft/Yii/Console/views/migration.php';
    /**
    ...
    public $generatorTemplateFiles = [
        'create_table'      => '@Yiisoft/Yii/Console/views/createTableMigration.php',
        'drop_table'        => '@Yiisoft/Yii/Console/views/dropTableMigration.php',
        'add_column'        => '@Yiisoft/Yii/Console/views/addColumnMigration.php',
        'drop_column'       => '@Yiisoft/Yii/Console/views/dropColumnMigration.php',
        'create_junction'   => '@Yiisoft/Yii/Console/views/createTableMigration.php',
    ];
    /**
