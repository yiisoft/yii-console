...
use Yiisoft\Yii\Console\Controllers\AssetController;
...
/**
 * Unit test for [[\Yiisoft\Yii\Console\Controllers\AssetController]].
 * @see AssetController
 *
 * @group console
 */
...
EOL;
    ...
    public function testDetectCircularDependency()
    {
        ...
        $this->expectException(\Yiisoft\Yii\Console\Exceptions\Exception::class);
...
/**
 * Mock class for [[\Yiisoft\Yii\Console\Controllers\AssetController]].
 */
