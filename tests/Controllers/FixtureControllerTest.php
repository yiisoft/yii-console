...
use Yiisoft\Yii\Console\Controllers\FixtureController;
use yii\tests\data\console\controllers\fixtures\FixtureStorage;
use yii\tests\TestCase;
use Yiisoft\Yii\Console\Exceptions\Exception;

/**
 * Unit test for [[\Yiisoft\Yii\Console\Controllers\FixtureController]].
...
{
    /**
     * @var \Yiisoft\Yii\Console\Tests\Controllers\FixtureConsoledController
     */
    ...
    protected function setUp()
    {
        ...
        $this->_fixtureController = $this->factory->create([
            '__class' => \Yiisoft\Yii\Console\Tests\Controllers\FixtureConsoledController::class,
            'interactive' => false,
            'globalFixtures' => [],
